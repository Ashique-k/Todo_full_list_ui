  ...
  Widget build(BuildContext context) {
    return Scaffold(
     ...
     title: Row(
       ...
       children: [
         Text("TODO",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.orange,fontSize: 15),),
         Text("LIST",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.blue,fontSize: 15),)
